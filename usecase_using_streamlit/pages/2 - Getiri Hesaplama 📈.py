...
def get_input():
    ...
    tutar = st.number_input("Yatırım tutarını giriniz?", label_visibility="hidden", placeholder="Yatırım tutarını giriniz?", min_value=0)
    # ss_dict = {
    #     "ticker": ticker, "start_date": start_date, "end_date":end_date, "hesaplama_tipi":hesaplama_tipi, "div_re": div_re, "tutar":tutar
    # }
    # for obj, val in ss_dict.items():
